...
public class TestDict {
	...
	try {
	    ...
	    System.out.println("Test 4 failed exception");
	}
	...
	try {
	    ...
	    System.out.println("Test 6 failed exception");
	}
	...
	try {
	    ...
	    System.out.println("Test 7 failed exception");
	}
	...
	try {
	    ...
	    System.out.println("Test 8 failed exception");
	}
	...
	try {
	    ...
	    System.out.println("Test 9 failed exception");
	}
	...
	try {
	    ...
	    try {
			...
			else System.out.println(rec.getKey().getWord());
	    }
	    catch (Exception e) {
			System.out.println("Test 16 failed exception");
	    }
	}
	catch (IOException e) {
